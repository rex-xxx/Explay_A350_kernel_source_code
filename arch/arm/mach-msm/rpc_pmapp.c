...
#define PMAPP_DISP_FLASHLIGHT_SET_PROC	36 //lct.huliangsheng
...
int pmapp_disp_flashlight_set(int value)//lct.huliangsheng
{
        if (value == 0 )
        {   
            return pmapp_rpc_set_only(0, 0, 0, 0, 1,
                PMAPP_DISP_FLASHLIGHT_SET_PROC);
        }else
        {
            return pmapp_rpc_set_only(1, 0, 0, 0, 1,
                PMAPP_DISP_FLASHLIGHT_SET_PROC);
        }
}
EXPORT_SYMBOL(pmapp_disp_flashlight_set);
