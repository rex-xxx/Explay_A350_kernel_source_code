...
struct msm_camera_device_platform_data {
	...
	void (*camera_vreg_config)(int vreg_en, int dvdd_mv, int need_dvdd); //zhaozy porting
#ifdef CONFIG_LCT_AW550
	void (*camera_csi_config_front)(struct clk_lookup *clock_tbl, size_t num_clocks);
#endif
