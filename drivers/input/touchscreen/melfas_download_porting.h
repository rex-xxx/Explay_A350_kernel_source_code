...
#define TKEY_CE_SET_HIGH()   	          			gpio_set_value(MCS6024_CE_GPIO,1);
#define TKEY_CE_SET_LOW()      	        		gpio_set_value(MCS6024_CE_GPIO,0);
#define TKEY_CE_SET_OUTPUT()   	        		gpio_tlmm_config(GPIO_CFG(MCS6024_CE_GPIO, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE);
#else
...
#define TKEY_INTR_SET_HIGH()             			gpio_set_value(MCS6024_IRQ_GPIO,1);   
#define TKEY_INTR_SET_LOW()              			gpio_set_value(MCS6024_IRQ_GPIO,0);   
#define TKEY_INTR_SET_OUTPUT()             		gpio_tlmm_config(GPIO_CFG(MCS6024_IRQ_GPIO, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE);      
#define TKEY_INTR_SET_INPUT()             			gpio_tlmm_config(GPIO_CFG(MCS6024_IRQ_GPIO, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE);  
#else
...
#define TKEY_I2C_SCL_SET_HIGH()			gpio_set_value(131,1);    			
#define TKEY_I2C_SCL_SET_LOW()			gpio_set_value(131,0);   		

#define TKEY_I2C_SDA_SET_HIGH()		  gpio_set_value(132,1); 				
#define TKEY_I2C_SDA_SET_LOW()			gpio_set_value(132,0); 			

#define TKEY_I2C_SCL_SET_OUTPUT()	gpio_tlmm_config(GPIO_CFG(131, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),GPIO_CFG_ENABLE);        			           							
#define TKEY_I2C_SDA_SET_OUTPUT()	gpio_tlmm_config(GPIO_CFG(132, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),GPIO_CFG_ENABLE);        			           										

#define TKEY_I2C_SCL_SET_INPUT()	gpio_tlmm_config(GPIO_CFG(131, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),GPIO_CFG_ENABLE);														
#define TKEY_I2C_SDA_SET_INPUT()	gpio_tlmm_config(GPIO_CFG(132, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),GPIO_CFG_ENABLE);   
...
#define TKEY_I2C_SET_INPUT()						TKEY_I2C_SCL_SET_INPUT();		\
...
#define MCSDL_DELAY_10MS								100000
