...
#if defined(CONFIG_LCT_AW551) || defined(CONFIG_LCT_AW550)
		       ...
		       dev_t rdev)
{
	...
	dev = parent->my_dev;
#if defined(CONFIG_LCT_AW551) || defined(CONFIG_LCT_AW550)
	sb = yaffs_dev_to_lc(dev)->super;
	if(sb->s_dev == MKDEV(31, 7) && current->cred->uid > 10000 && dev->n_free_chunks <= 7680) {
				...
				loff_t * pos)
{
	...
	sb = yaffs_dev_to_lc(dev)->super;
	if(sb->s_dev == MKDEV(31, 7) && current->cred->uid > 10000 && dev->n_free_chunks <= 7680) {
		ret = get_pid_cmdline(current, buff);
		if(ret > 0) {
			//pr_info("process1111: %s\n", buff);
			if(strcmp(buff, "com.android.phone") && strcmp(buff, "com.android.systemui")
				&& strcmp(buff, "android.process.acore") && strcmp(buff, "com.android.mms")
				&& strcmp(buff, "android.process.media") && strcmp(buff, "com.android.settings")
				&& strcmp(buff, "com.android.launcher")) {
				return -ENOMEM;
			}
		}
	}	
