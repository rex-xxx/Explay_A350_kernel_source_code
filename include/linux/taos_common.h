...
#define TAOS_IOCTL_ALS_READ_DATA		_IOR(TAOS_IOCTL_MAGIC, 17, int*)
#define TAOS_IOCTL_PROX_READ_DATA 	_IOR(TAOS_IOCTL_MAGIC, 18, int*)
#define TAOS_IOCTL_ENTER_FACTORY_MODE		_IO(TAOS_IOCTL_MAGIC, 19)
#define TAOS_IOCTL_SET_FACTORY_MODE		_IO(TAOS_IOCTL_MAGIC, 20)
