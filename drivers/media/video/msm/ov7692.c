...
static int ov7692_set_brightness(int brightness)
{
	int rc = 0;
	CDBG("--CAMERA-- %s ...(Start)\n",__func__);
	CDBG("--CAMERA-- %s ...brightness= %d\n",__func__ , brightness);

		switch (brightness)	//use exposure compensation parameter instead of brightness
		{
		case CAMERA_BRIGHTNESS_LV0:
			CDBG("--CAMERA--CAMERA_BRIGHTNESST_LV0\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv4_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV1:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV1\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv3_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV2:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV2\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv2_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV3:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV3\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv1_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV4:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV4\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv0_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV5:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV5\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv5_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV6:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV6\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv6_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV7:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV7\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv7_tbl);
			break;
		case CAMERA_BRIGHTNESS_LV8:
			CDBG("--CAMERA--CAMERA_BRIGHTNESS_LV8\n");
			rc = OV7692Core_WritePREG(ov7692_brightness_lv8_tbl);
			break;
		default:
...
static struct clk_lookup ov7692_csi_tbl[] = {
...
static unsigned num_ov7692_csi_tbl = ARRAY_SIZE(ov7692_csi_tbl);
#endif
...
#ifdef CONFIG_LCT_AW550
    info->pdata->camera_csi_config_front(ov7692_csi_tbl,num_ov7692_csi_tbl);
#endif
