...
static struct resource resources_sdc2[] = {
	...
	{
		.name	= "sdcc_dma_chnl",
		.start	= DMOV_TSIF_CHAN,//DMOV_SDC2_CHAN,//zhaozy porting
		.end	= DMOV_TSIF_CHAN,//DMOV_SDC2_CHAN,//zhaozy porting
		.flags	= IORESOURCE_DMA,
	},
	{
		.name	= "sdcc_dma_crci",
...
static struct kgsl_device_platform_data kgsl_3d0_pdata = {
	.pwr_data = {
		...
		//.idle_timeout = HZ/5,
		.idle_timeout = HZ,//if the issue still been see. than thange the HZ to 0xFFFFFFFF
		.nap_allowed = false,
	},
	.clk = {
		.name = {
