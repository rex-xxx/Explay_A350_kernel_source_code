...
extern void   get_power_alarm_status(unsigned int  *alarm_status);
...
from_old_alarm_set:
	...
	case ANDROID_ALARM_GET_TIME(0):
        ...
        case ANDROID_ALARM_RTC_HW_WAKEUP:
		...
		case ANDROID_ALARM_ELAPSED_REALTIME:
			...
			break;
		case ANDROID_ALARM_TYPE_COUNT_OLD:
	...
	case  ANDROID_GET_POWER0FF_ALARM_STATUS:
		
		get_power_alarm_status(&new_alarm_status);
		
		if (copy_to_user((void __user *)arg, &new_alarm_status,sizeof(new_alarm_status))) 
		{
			rv = -EFAULT;
			goto err1;
		}
