...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	{0x03, 0x01, 0x01, 0x00},
	/* timing   */
	{0x66, 0x26, 0x1a, 0x00, 0x1d, 0x92, 0x1e, 0x8d,
	0x1d, 0x03, 0x04},
	/* phy ctrl */
	{0x7f, 0x00, 0x00, 0x00},
	/* strength */
	{0xbb, 0x02, 0x06, 0x00},
	/* pll control */
	{0x01, 0x9f, 0x31, 0xda, 0x00, 0x40, 0x37, 0x62,
	0x01, 0x0f, 0x07,
	0x05, 0x14, 0x03, 0x0, 0x0, 0x0, 0x20, 0x0, 0x02, 0x0},
};


static int __init mipi_video_default_hvga_pt_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("NULL"))
		return 0;
#else
	return 0;
#endif
	...
	pinfo.lcdc.v_back_porch = 2;//5;
	pinfo.lcdc.v_front_porch = 2;//5;
	...
	pinfo.mipi.vc = 0;
	pinfo.mipi.rgb_swap = DSI_RGB_SWAP_BGR; //RGB
	...
	ret = mipi_default_device_register(&pinfo, 1,
						MIPI_DSI_PANEL_VGA);
...
module_init(mipi_video_default_hvga_pt_init);
