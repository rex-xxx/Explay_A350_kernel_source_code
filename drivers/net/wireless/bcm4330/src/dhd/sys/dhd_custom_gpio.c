...
extern void wifi_detect_change(int);
/* Customer specific Host GPIO defintion  */
#ifdef  CONFIG_LCT_AE770
static int dhd_oob_gpio_num = 29; //29 for ae770 //19;// 28 is for aw70 project only
#else
static int dhd_oob_gpio_num = 19;   // 28 is for aw70 project only
#endif
